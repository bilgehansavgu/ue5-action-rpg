...
#include "Actions/ARPGAreaOfEffectSpellAction.h"
...
UARPGAreaOfEffectSpellAction::UARPGAreaOfEffectSpellAction()
{
}

void UARPGAreaOfEffectSpellAction::StartAction_Implementation(UARPGActionBase* Action,
	AActor* Instigator)
{
...
void UARPGAreaOfEffectSpellAction::StopAction_Implementation(UARPGActionBase* Action,
	AActor* Instigator)
{
	Super::StopAction_Implementation(Action, Instigator);
}

void UARPGAreaOfEffectSpellAction::SpawnProjectile(ACharacter* InstigatorCharacter)
{
	if(ensureAlways(AreaOfEffectClass))
	{
		...
		{
			World->SpawnActor<AActor>(AreaOfEffectClass, SpawnTransform, SpawnParameters);
		}
	}
}