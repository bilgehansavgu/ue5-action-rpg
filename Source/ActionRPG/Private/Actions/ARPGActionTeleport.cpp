...
#include "Actions/ARPGActionTeleport.h"

#include "GameFramework/Character.h"
#include "Kismet/GameplayStatics.h"
#include "Projectiles/ARPGProjectileBase.h"

UARPGActionTeleport::UARPGActionTeleport()
{
}

void UARPGActionTeleport::StartAction_Implementation(UARPGActionBase* Action, AActor* Instigator)
{
...
void UARPGActionTeleport::StopAction_Implementation(UARPGActionBase* Action, AActor* Instigator)
{
	Super::StopAction_Implementation(Action, Instigator);
}

void UARPGActionTeleport::SpawnProjectile(ACharacter* InstigatorCharacter)
{
	if(ensureAlways(TeleportSpellClass))
	{
		...
		{
			World->SpawnActor<AActor>(TeleportSpellClass, SpawnTransform, SpawnParameters);
		}
	}
}
